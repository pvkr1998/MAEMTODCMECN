...
"""
This function returns acceptance rate
"""
    ...
    for u in users.index:
        ...
        for step in users['servers_set'][u]:
            ...
            if prev_node==-2:   #no previous => uplink + exec + downlink
                #for s in step:
                s = step[random.randint(0,np.argmin(step)-1)]
                #uplink
